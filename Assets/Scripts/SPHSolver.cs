...
public class SPHSolver : MonoBehaviour
{
    ...
    private static bool Intersect(EnvironemntCollider collider, Vector3 position, float radius, out Vector3 penetrationNormal, out Vector3 penetrationPosition, out float penetrationLength)
    {
    ...
    private static Vector3 DampVelocity(EnvironemntCollider collider, Vector3 velocity, Vector3 penetrationNormal, float drag)
    {
    ...
    private void ComputeColliders()
    {
        ...
        EnvironemntCollider[] colliders = new EnvironemntCollider[collidersGO.Length];
